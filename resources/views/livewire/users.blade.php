...
@if(session()->has('error')) 
    <div class="bg-white text-right py-4 lg:px-4 rounded animate-fade-in-down">
    ...
    <div class="mt-1">
        ...
        <div class="mt-2">
            <table class="border-collapse w-full">
                ...
                <tbody data-turbolinks="false" wire:poll.2000ms>
                    ...
                    <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                        ...
                        <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                            ...
                            <span class="lg:hidden absolute top-auto left-0  bg-blue-200 px-1 py-1 text-xs font-bold">Role</span>
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 transition duration-500 ease-in-out transform hover:-translate-y-1">{{ $role->role_id === 1 ? 'Admin' : '' }} {{ $role->role_id === 2 ? 'Vendor' : '' }} {{ $role->role_id === 3 ? 'Technician' : '' }} </span>
                            @endforeach
                        </td>
