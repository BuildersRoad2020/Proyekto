<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('admin', App\Models\Users::class)
                    <x-jet-nav-link href="{{ route('contractor') }}" :active="request()->routeIs('contractor')">
                        {{ __('Contractors') }}
                    </x-jet-nav-link>
                    @endcan

                    @can('adminvendor', App\Models\Users::class)
                    <x-jet-nav-link href="{{ route('companydetails') }}" :active="request()->routeIs('companydetails')">
                        {{ __('CompanyDetails') }}
                    </x-jet-nav-link>
                     @endcan
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('adminsettings') }}">
                                {{ __('Settings') }}
                            </x-jet-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endcan
            @can('admin', App\Models\Users::class)
            <x-jet-responsive-nav-link href="{{ route('contractor') }}" :active="request()->routeIs('contractor')">
                {{ __('Contractors') }}
            </x-jet-responsive-nav-link>
            @endcan
            @can('adminvendor', App\Models\Users::class)
            <x-jet-responsive-nav-link href="{{ route('companydetails') }}" :active="request()->routeIs('companydetails')">
                {{ __('CompanyDetails') }}
            </x-jet-responsive-nav-link>
            @endcan
            @can('adminvendor2', App\Models\Users::class)
